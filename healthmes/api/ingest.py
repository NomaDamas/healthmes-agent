    ...
    *,
    ...
    try:
        ...
        if (
            ...
            and not ack.status_persistence_uncertain
        ):
        ...
        # The iPhone advances its HealthKit anchor only after a certain ACK.
        # Keep this receipt pending as well, so the exact same request can
        # retry forwarding and status persistence instead of replaying an
        # acknowledgement that the server could not verify.
        await anyio.to_thread.run_sync(
