...
def _responses_request(
    ...
    *,
    ...
    instructions = (
        ...
        "none, action, risk, mutation, or explicit_tracking. record_summary "
        "is optional and retained only as a backward-compatible transient "
        "hint; never put raw identifiers or sensitive detail in it. HealthMes "
        "derives the stored category-only summary from the verified "
        "persistence intent. Use only source reference IDs returned by tools. "
