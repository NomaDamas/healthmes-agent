...
def seed(session) -> dict[str, str]:
    ...
    tree = {
        ...
        "children": [
            ...
            {"id": "q1", "type": "llm_step",
             "label": "판단 1 — 16시 고강도 블록, 오늘 오후 에너지로 가능한가?",
             "detail": "에너지 예보 58 < 고강도 임계 65, 스트레스 회복 미완",
             "children": [
                 {"id": "q1a", "type": "option", "label": "가능 — 그대로 유지",
                  "detail": "기각: 예보 58, 어젯밤 수면 68점으로 회복 부족", "children": []},
                 {"id": "q2", "type": "llm_step",
                  "label": "판단 2 — 옮긴다면 언제가 최적인가?",
                  "detail": "마감(내일 18시)까지 남은 고에너지 창 비교",
                  "children": [
                      {"id": "q2a", "type": "option", "label": "오늘 저녁 19-20시",
                       "detail": "기각: 하강 구간(60→55) + 러닝 태스크와 충돌", "children": []},
                      {"id": "q2b", "type": "option", "label": "내일 오전 09-11시",
                       "detail": "채택: 에너지 예보 84, 마감 여유 7시간 확보",
                       "children": [
                           {"id": "q3", "type": "llm_step",
                            "label": "판단 3 — 비게 된 오늘 16시는 어떻게 쓰나?",
                            "detail": "마감 리스크 vs 회복 필요의 균형",
                            "children": [
                                {"id": "q3a", "type": "option", "label": "완전히 비워 휴식",
                                 "detail": "기각: 마감 전 준비 항목 2건 잔존", "children": []},
                                {"id": "q3b", "type": "option",
                                 "label": "저강도 정리 작업 배치 (16:00-17:30)",
                                 "detail": "채택: energy_demand=low 태스크로 대체", "children": []},
                            ]},
                       ]},
                  ]},
             ]},
            {"id": "act1", "type": "action", "label": "propose_schedule_blocks 호출",
             "detail": "16:00-17:30 저강도 블록 + 내일 09:00-11:00 집중 블록 — 사용자 승인 대기",
             "children": []},
        ],
    }
