...
public struct InputSourceDescriptor: Codable, Equatable, Identifiable {
    ...
    /// Older descriptors predate the source-level switch. Missing means
    /// enabled so existing cached fixtures remain backwards compatible.
    public let sourceEnabled: Bool?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case sourceEnabled = "source_enabled"
...
public enum InputPauseUpdate: Equatable {
    case unchanged
...
public struct InputControlPlaneSettingsUpdate: Encodable, Equatable {
    ...
    public let sourceEnabled: Bool?
    public let excludedApps: [String]?
    public let pauseUpdate: InputPauseUpdate
    public let decisionAccessEnabled: Bool?
    ...
    public init(
        ...
        pauseUpdate: InputPauseUpdate = .unchanged,
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(sourceEnabled, forKey: .sourceEnabled)
        try container.encodeIfPresent(excludedApps, forKey: .excludedApps)
        switch pauseUpdate {
        case .unchanged:
            break
        case .paused(let until):
            try container.encode(until, forKey: .pausedUntil)
        case .resumed:
...
public enum InputControlPlanePresentation {
    ...
    public static func limitation(_ code: String) -> String {
        switch code {
        case "wearable_provider_details_in_management_hub":
            return "Provider connections, sync actions, and device inventory are managed in the Wearables Settings Hub."
