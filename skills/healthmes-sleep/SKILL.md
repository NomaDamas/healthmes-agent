...
description: Interpret an explicitly sleep-focused question or prepare a confirmed Oura actual-sleep Calendar update. Use for questions about last night's sleep, accumulated sleep debt, whether sleep evidence is strong enough to change today's plan, or requests to sync/update actual sleep time in Calendar. Do not use for the generic “오늘 어떻게 회복하지?” request when the WHOOP recovery-package skill is available.
---
